...
void Renderer::render(GLFWwindow* window, Camera &camera, const float &screenRatio, float &initialTime) {
    ...
    glUniformMatrix4fv(this->projection_uniform , 1 , GL_FALSE , glm::value_ptr(camera.getPerspective(screenRatio)));
